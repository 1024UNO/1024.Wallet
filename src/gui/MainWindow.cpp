...
// Copyright (c) 2016-2018 The 1024 developers
...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("1024 Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.1024.uno in Documentation section"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("1024 Wallet %1")).arg(Settings::instance().getVersion());
